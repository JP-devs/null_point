...
from pcap_analyzer import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class PcapAnalyzerScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("PCAP Analyzer", id="title")
            yield Input(placeholder="Enter path to PCAP...", id="input_field")
