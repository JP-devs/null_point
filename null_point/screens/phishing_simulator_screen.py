...
from phishing_simulator import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class PhishingSimulatorScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("Phishing Simulator", id="title")
            yield Input(placeholder="Enter target email...", id="input_field")
