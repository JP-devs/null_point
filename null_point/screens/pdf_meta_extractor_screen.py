...
from pdf_meta_extractor import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class PdfMetaExtractorScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("PDF Meta Extractor", id="title")
            yield Input(placeholder="Enter path to PDF...", id="input_field")
