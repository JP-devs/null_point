...
from proxy_verifier import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class ProxyVerifierScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("Proxy Verifier", id="title")
            yield Input(placeholder="Enter proxy list path...", id="input_field")
