...
from sql_injection_tester import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class SqlInjectionTesterScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("SQLi Tester", id="title")
            yield Input(placeholder="Enter target URL/Parameter...", id="input_field")
