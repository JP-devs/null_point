...
from http_header_checker import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class HttpHeaderCheckerScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("HTTP Header Checker", id="title")
            yield Input(placeholder="Enter URL...", id="input_field")
