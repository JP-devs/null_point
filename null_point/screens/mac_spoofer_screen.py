...
from mac_spoofer import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class MacSpooferScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("MAC Spoofer", id="title")
            yield Input(placeholder="Enter new MAC address...", id="input_field")
