...
from player_profile_analyzer import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class PlayerProfileAnalyzerScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("Player Profile Analyzer", id="title")
            yield Input(placeholder="Enter username...", id="input_field")
