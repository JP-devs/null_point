...
from network_traffic_analyzer import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class NetworkTrafficAnalyzerScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("Network Traffic Analyzer", id="title")
            yield Input(placeholder="Enter interface (e.g., eth0)...", id="input_field")
