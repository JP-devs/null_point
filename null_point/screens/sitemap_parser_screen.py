...
from sitemap_parser import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class SitemapParserScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("Sitemap Parser", id="title")
            yield Input(placeholder="Enter sitemap URL...", id="input_field")
