...
from ssh_key_gen import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class SshKeyGenScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("SSH Key Gen", id="title")
            yield Input(placeholder="Enter email for key...", id="input_field")
