...
from subnet_calculator import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class SubnetCalculatorScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("Subnet Calculator", id="title")
            yield Input(placeholder="Enter IP and CIDR (e.g., 192.168.1.0/24)...", id="input_field")
