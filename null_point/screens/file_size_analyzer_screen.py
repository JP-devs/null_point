...
from file_size_analyzer import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class FileSizeAnalyzerScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("File Size Analyzer", id="title")
            yield Input(placeholder="Enter folder path...", id="input_field")
