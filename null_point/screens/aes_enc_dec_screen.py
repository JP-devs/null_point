...
from aes_enc_dec import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class AesEncDecScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("AES Enc/Dec", id="title")
            yield Input(placeholder="Enter text, key, and mode (enc/dec)...", id="input_field")
