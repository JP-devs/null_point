...
from file_integrity_checker import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class FileIntegrityCheckerScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("File Integrity Checker", id="title")
            yield Input(placeholder="Enter file path...", id="input_field")
