...
from valorant_osint import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class ValorantOsintScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("Valorant OSINT", id="title")
            yield Input(placeholder="Enter Riot ID...", id="input_field")
