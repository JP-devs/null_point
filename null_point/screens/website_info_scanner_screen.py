...
from website_info_scanner import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class WebsiteInfoScannerScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("Website Info Scanner", id="title")
            yield Input(placeholder="Enter target URL...", id="input_field")
