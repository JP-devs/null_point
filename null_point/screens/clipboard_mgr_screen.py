...
from clipboard_mgr import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class ClipboardMgrScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("Clipboard Manager", id="title")
            yield Input(placeholder="Enter command (save/list/clear)...", id="input_field")
