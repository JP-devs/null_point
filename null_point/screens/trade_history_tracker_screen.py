...
from trade_history_tracker import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class TradeHistoryTrackerScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("Trade History Tracker", id="title")
            yield Input(placeholder="Enter user ID...", id="input_field")
