...
from disk_usage_analyzer import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class DiskUsageAnalyzerScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("Disk Usage Analyzer", id="title")
            yield Input(placeholder="Enter drive (e.g. C:/)...", id="input_field")
