...
from rsa_key_gen import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class RsaKeyGenScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("RSA Key Gen", id="title")
            yield Input(placeholder="Enter key size (e.g., 2048)...", id="input_field")
