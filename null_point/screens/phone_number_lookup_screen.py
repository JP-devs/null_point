...
from phone_number_lookup import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class PhoneNumberLookupScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("Phone Number Lookup", id="title")
            yield Input(placeholder="Enter phone number...", id="input_field")
