...
from env_var_checker import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class EnvVarCheckerScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("Env Var Checker", id="title")
            yield Input(placeholder="Enter variable name...", id="input_field")
