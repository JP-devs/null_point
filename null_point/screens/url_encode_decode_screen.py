...
from url_encode_decode import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class UrlEncodeDecodeScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("URL Encoder/Decoder", id="title")
            yield Input(placeholder="Use 'enc:text' or 'dec:text'...", id="input_field")
