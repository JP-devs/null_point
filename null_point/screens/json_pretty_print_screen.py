...
from json_pretty_print import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class JsonPrettyPrintScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("JSON Pretty Print", id="title")
            yield Input(placeholder="Paste raw JSON...", id="input_field")
