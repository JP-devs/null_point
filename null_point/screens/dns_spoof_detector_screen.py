...
from dns_spoof_detector import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class DnsSpoofDetectorScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("DNS Spoof Detector", id="title")
            yield Input(placeholder="Enter domain to monitor...", id="input_field")
