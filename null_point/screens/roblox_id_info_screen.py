...
from roblox_id_info import run_tool

def strip_ansi(text):
    return re.sub(r'\x1b\[[0-9;]*m', '', text)

class RobloxIdInfoScreen(Screen):
    CSS_PATH = "../theme.css"
    BINDINGS = [
    ...
    def compose(self) -> ComposeResult:
        ...
        with Vertical(classes="tool-container"):
            yield Label("Roblox ID Info", id="title")
            yield Input(placeholder="Enter Roblox ID...", id="input_field")
